 ...
 * map to /index.php/welcome/<method_name>
    ...
    function insert_book($data){
        ...
        $query = "INSERT INTO book (book_no,book_title,book_type,abstract,author,description,publisher,tags,other_details,date_published)".
            " VALUES ('{$data['book_no']}'".
            ",'{$data['book_title']}'".
            ",'{$data['type']}'".
    ...
    function get_book($book_no){
        ...
        $result[0]->other_details = explode("¦",$result[0]->other_details);
        foreach($result[0]->other_details as &$detail){
            $arr = explode("»",$detail);
            $detail = [];
            $detail['name'] = $arr[0];
